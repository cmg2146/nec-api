...
Revision ID: c78c0bfb2d4d
Revises:
Create Date: 2023-02-28 21:02:15.159765
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_pano_floor_id'), 'pano', ['floor_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_pano_floor_id'), table_name='pano')
