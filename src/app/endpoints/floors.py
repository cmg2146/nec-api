"""API Endpoints for Floors and Floor Overlays"""
...
#==========================================================================================
@router.post("{id}/overlays/", status_code=status.HTTP_201_CREATED, response_model=schemas.FloorOverlay)
...
@router.get("/{id}/overlays", response_model=list[schemas.FloorOverlay])
async def get_overlays_for_floor(
...
#==========================================================================================
@router.get("/overlays/", response_model=list[schemas.FloorOverlay])
...
@router.get("/overlays/{id}", response_model=schemas.FloorOverlay)
...
@router.put("/overlays/{id}", response_model=schemas.FloorOverlay)
...
@router.delete("/overlays/{id}", status_code=status.HTTP_204_NO_CONTENT)
